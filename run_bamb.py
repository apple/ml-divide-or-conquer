...
def run_bambooglesanity4(model, modelname, datasetname, seed, backbone, subset=-1, qdname='gpt-3.5-turbo', batch=1, whether_train=False, gpu_id=0, total_gpu=1):
    ...
    decomposor_path = global_path + 'golden-decomposing-by-' + qdname + '/' + 'full_train-bamboogle_cot_decompose_bamboogle_0-1_0602' + '.csv'
...
if __name__ == '__main__':
    ...
    if args.dataset == 'drop':
        ...
        #    elif '_qd-0shot_vicuna' in args.backbone or '_qd-1shot_vicuna' in args.backbone:
        #        run_drop(model, args.model, args.dataset, args.seed, load_vicuna_model(args.backbone_path, args.backbone), args.subset, args.decompose)
        #    else:
    ...
    if args.dataset == 'gsm8k':
        ...
        if args.backbone == 'vinilla_vicuna':
            ...
            decompose_gsm8k(model, args.model, args.dataset, args.seed, load_vicuna_model(args.backbone_path, args.backbone), args.subset, args.whether_train, args.gpu_id, args.total_gpu)
        else:
    ...
    if args.dataset == 'bamboogle':
        if args.backbone == 'vinilla_vicuna':
            decompose_bamboogle(model, args.model, args.dataset, args.seed, load_vicuna_model('lmsys/vicuna-13b-v1.3', args.backbone), args.subset, args.whether_train, args.gpu_id, args.total_gpu)
        elif '_qd-0shot_vicuna' in args.backbone or '_qd-1shot_vicuna' in args.backbone:
            decompose_bamboogle(model, args.model, args.dataset, args.seed, load_vicuna_model(args.backbone_path, args.backbone), args.subset, args.whether_train, args.gpu_id, args.total_gpu)
        else:
    ...
    if args.dataset == 'gsm8ksanity4':
        if args.backbone == 'vinilla_vicuna':
            ...
            run_gsm8ksanity4(model, args.model, args.dataset, args.seed, load_vicuna_model(args.backbone_path, args.backbone), args.subset, args.qd, args.batch, args.whether_train, args.gpu_id, args.total_gpu)
        else:
    ...
    if args.dataset == 'dropsanity4':
        if args.backbone == 'vinilla_vicuna':
            ...
            run_dropsanity4(model, args.model, args.dataset, args.seed, load_vicuna_model(args.backbone_path, args.backbone), args.subset, args.qd, args.batch, args.whether_train, args.gpu_id, args.total_gpu)
        else:
    ...
    if args.dataset == 'bambooglesanity4':
        if args.backbone == 'vinilla_vicuna':
            run_bambooglesanity4(model, args.model, args.dataset, args.seed, load_vicuna_model('lmsys/vicuna-13b-v1.3', args.backbone), args.subset, args.qd, args.batch, args.whether_train, args.gpu_id, args.total_gpu)
        elif '_qd-0shot_vicuna' in args.backbone or '_qd-1shot_vicuna' in args.backbone:
            run_bambooglesanity4(model, args.model, args.dataset, args.seed, load_vicuna_model(args.backbone_path, args.backbone), args.subset, args.qd, args.batch, args.whether_train, args.gpu_id, args.total_gpu)
        else:
